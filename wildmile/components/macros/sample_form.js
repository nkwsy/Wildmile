    ...
    <Box>
      ...
      <Group>
        ...
        <MultiSelect
          ...
          miw={200}
          data={[
            { value: "Artificial Structure", label: "Artificial Structure" },
          ...
          {bugData.map((bug, index) => (
            <div key={index} style={{ display: "flex", alignItems: "center" }}>
              <Autocomplete
                ...
                value={bug.type}
                onChange={(value) => handleBugDataChange(index, "type", value)}
              />
              <NumberInput
                label="Bug Count"
                value={bug.count}
                onChange={(value) => handleBugDataChange(index, "count", value)}
              />
              <Button
                variant="outline"
                color="red"
