...
import { getAllLogs, createLog, getFilteredLogs, updateLogItems } from '/lib/db/trash'
...
handler
  ...
  .post(async (req, res) => {
    ...
    return res.status(201).json(await updateLogItems(req.body.items, req.query.id))
  })
